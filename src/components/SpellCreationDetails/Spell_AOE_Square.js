...
function SpellAOESquare({ onAOEChange, isSelected }) {
                ...
                <span style={{ marginLeft: '10px' }}>
                    ...
                    <span style={{ cursor: 'pointer' }}>
                        <svg width="20" height="20" viewBox="0 0 20 20">
                            <rect x="1" y="1" width="18" height="18" stroke="#000" strokeWidth="2" fill="#fff" />
                        </svg>
                    </span>
                </span>
            </div>
